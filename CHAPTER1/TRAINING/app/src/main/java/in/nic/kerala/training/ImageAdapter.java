...
class ImageAdapter extends BaseAdapter {
    ...
    private int [] imageId={R.drawable.search,R.drawable.feedback,R.drawable.fileupload,R.drawable.map,R.drawable.notification,R.drawable.sql};
                ...
                public void onClick(View v) {
                 ...
                 /*
                    if(position==0)
                    {
                        ...
                        Intent in2 = new Intent(context, MapActivity.class);
                        context.startActivity(in2);
